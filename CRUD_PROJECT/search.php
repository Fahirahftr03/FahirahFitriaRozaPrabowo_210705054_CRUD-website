...
<head>
    ...
    <style>
        ...
        .search-form input[type="text"] {
            ...
            background-color: #fff; /* Mengubah latar belakang input menjadi putih */
            border: 1px solid #ddd; /* Menambahkan border tipis abu-abu */
        }
        ...
        .search-form input[type="text"]:focus {
            ...
            border-color: #76c043; /* Mengubah warna border saat fokus */
        }
